      ...
      <main style={{ minHeight: "100vh", background: "#0f0a05", position: "relative", overflow: "hidden" }}>
        ...
        <section style={{ padding: "48px 20px", maxWidth: "600px", margin: "0 auto", position: "relative", zIndex: 10 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
            {[
              ...
              { icon: "🔥", title: "Deep Ministry Flow",          desc: "Gift of Knowledge, Impartation, Edification, Slow Down moments, and Return to Anchor — built for powerful delivery." },
        ...
        <section style={{ padding: "40px 20px", maxWidth: "600px", margin: "0 auto", position: "relative", zIndex: 10 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
            {[
              ...
              { q: "Are the sermons unique to each pastor?",     a: "Yes. Every sermon is freshly generated. Two pastors using the same topic will receive completely different sermons. All saved sermons are private to each user." },
              { q: "What languages does it support?",            a: "36+ languages including English, Spanish, French, Portuguese, Samoan, Tongan, Fijian, Te Reo Māori, Tok Pisin, Swahili, Yoruba, Arabic, Hindi, Mandarin, Korean, Japanese, Russian, and more." },
              ...
              { q: "What is the Ministry Prayer feature?",          a: "Ministry Prayers are completely separate from sermons. They are pastor-led congregational prayers with scripture declarations, intercession sections, congregational responses, and a corporate declaration the whole church speaks aloud together. They are not sermon outlines — they are ready-to-lead prayer ministry tools." },
              { q: "What is the difference between a sermon and a prayer in this app?", a: "A sermon has Teaching Points, Scripture explanations, Application, an Altar Call and a Closing Prayer — it is designed to teach and preach. A Ministry Prayer has Prayer Sections with intercession language, Scriptures declared as weapons, Congregational Responses spoken aloud, a Corporate Declaration the church speaks together, and a Closing Blessing over the congregation. No teaching points, no explanations — pure intercession and declaration." },
              { q: "What types of Ministry Prayers are available?",  a: "Two types — General Prayer for congregational ministry needs (Healing, Peace, Provision, Family, Salvation of Loved Ones, Grief, Guidance and more), and Warfare Prayer for leading the church in spiritual battle (Fear, Generational Curses, Depression, Addiction, Spiritual Oppression, Marital Warfare and more). Each prayer is specifically built around the topic chosen — not generic." },
              { q: "Does the prayer match the topic I choose?",      a: "Yes — completely. If you select General Prayer and choose Salvation of Loved Ones, every section of the prayer is specifically about interceding for unsaved loved ones — breaking strongholds over them, divine encounters, preservation. If you select Warfare and choose Depression & Heaviness, the prayer specifically targets that spirit throughout — armour of God against depression, casting down thoughts of despair, calling down Holy Spirit for restoration. Nothing is generic." },
            ].map((faq, i) => (
        ...
        <section style={{ padding: "40px 20px 100px", textAlign: "center", position: "relative", zIndex: 10 }}>
          <div className="glass gold-glow" style={{ maxWidth: "480px", margin: "0 auto", padding: "40px 24px", borderRadius: "16px" }}>
            ...
            <p style={{ color: "#a8956e", marginBottom: "28px", lineHeight: 1.7, fontSize: "14px" }}>
              Join pastors and ministers worldwide building Scripture-anchored sermons.
            </p>
        ...
        <footer style={{ padding: "24px 20px", borderTop: "1px solid rgba(245,158,11,0.07)", textAlign: "center", position: "relative", zIndex: 10 }}>
          ...
          <div style={{ marginTop: "16px", display: "flex", justifyContent: "center", gap: "20px", flexWrap: "wrap" }}>
            {["Sermon Builder", "Sermon Topics", "Preach Mode", "Series Builder", "36+ Languages", "PDF Export"].map(l => (
